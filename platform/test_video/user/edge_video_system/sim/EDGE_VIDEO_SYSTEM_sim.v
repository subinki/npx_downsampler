...
/* synthesis syn_force_seq_prim="clk_vomif" */;
  ...
  // ***** simulation-only tie-off (edge_video_system 미동작, X 전파 방지) *****
  assign vdma_sxawid = 0;
  assign vdma_sxawaddr = 0;
  assign vdma_sxawlen = 0;
  assign vdma_sxawsize = 0;
  assign vdma_sxawburst = 0;
  assign vdma_sxawvalid = 0;
  assign vdma_sxwid = 0;
  assign vdma_sxwdata = 0;
  assign vdma_sxwstrb = 0;
  assign vdma_sxwlast = 0;
  assign vdma_sxwvalid = 0;
  assign vdma_sxbready = 0;
  assign vdma_sxarid = 0;
  assign vdma_sxaraddr = 0;
  assign vdma_sxarlen = 0;
  assign vdma_sxarsize = 0;
  assign vdma_sxarburst = 0;
  assign vdma_sxarvalid = 0;
  assign vdma_sxrready = 0;
  assign vdma_ctrl_rprdata = 0;
  assign vdma_ctrl_rpready = 1'b1;
  assign vdma_ctrl_rpslverr = 0;
  assign vim_sxawid = 0;
  assign vim_sxawaddr = 0;
  assign vim_sxawlen = 0;
  assign vim_sxawsize = 0;
  assign vim_sxawburst = 0;
  assign vim_sxawvalid = 0;
  assign vim_sxwid = 0;
  assign vim_sxwdata = 0;
  assign vim_sxwstrb = 0;
  assign vim_sxwlast = 0;
  assign vim_sxwvalid = 0;
  assign vim_sxbready = 0;
  assign vim_sxarid = 0;
  assign vim_sxaraddr = 0;
  assign vim_sxarlen = 0;
  assign vim_sxarsize = 0;
  assign vim_sxarburst = 0;
  assign vim_sxarvalid = 0;
  assign vim_sxrready = 0;
  assign vom_sxawid = 0;
  assign vom_sxawaddr = 0;
  assign vom_sxawlen = 0;
  assign vom_sxawsize = 0;
  assign vom_sxawburst = 0;
  assign vom_sxawvalid = 0;
  assign vom_sxwid = 0;
  assign vom_sxwdata = 0;
  assign vom_sxwstrb = 0;
  assign vom_sxwlast = 0;
  assign vom_sxwvalid = 0;
  assign vom_sxbready = 0;
  assign vom_sxarid = 0;
  assign vom_sxaraddr = 0;
  assign vom_sxarlen = 0;
  assign vom_sxarsize = 0;
  assign vom_sxarburst = 0;
  assign vom_sxarvalid = 0;
  assign vom_sxrready = 0;
  assign video_ctrl_rprdata = 0;
  assign video_ctrl_rpready = 1'b1;
  assign video_ctrl_rpslverr = 0;
  assign hdmi_rclk_ival = 0;
  assign hdmi_rdata_ival = 0;
  assign cis_rclk_ival = 0;
  assign cis_rdata_ival = 0;
  assign HDMI_RX_RST_N = 0;
  assign CIS_MCLK = 0;
  assign CIS_RESET_N = 0;
  assign CIS_PD_N = 0;
  assign HDMI_TX_DCK = 0;
  assign HDMI_TX_DE = 0;
  assign HDMI_TX_HS = 0;
  assign HDMI_TX_VS = 0;
  assign HDMI_TX_RST_N = 0;
  assign HDMI_TX_VD = 0;
  assign HDMI_TX_AO_MCLK = 0;
  assign HDMI_TX_AO_SCK = 0;
  assign HDMI_TX_AO_WS = 0;
  assign HDMI_TX_AO_SD = 0;
  assign HDMI_TX_AO_SPDIF = 0;
  // HDMI_I2C_SCL : left undriven (Z)
  // HDMI_I2C_SDA : left undriven (Z)
  // CIS_I2C_SCL : left undriven (Z)
  // CIS_I2C_SDA : left undriven (Z)
endmodule
