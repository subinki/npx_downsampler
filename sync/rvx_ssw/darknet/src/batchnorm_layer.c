...
layer make_batchnorm_layer(int batch, int w, int h, int c)
{
    ...
    layer.mean_delta = (float*)calloc(c, sizeof(float));
    layer.variance_delta = (float*)calloc(c, sizeof(float));

    layer.rolling_mean = (float*)calloc(c, sizeof(float));
    layer.rolling_variance = (float*)calloc(c, sizeof(float));

    layer.x = (float*)calloc(h * w * c * batch, sizeof(float));
    layer.x_norm = (float*)calloc(h * w * c * batch, sizeof(float));
