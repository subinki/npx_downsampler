...
void Adafruit_RGBLCDShield::_digitalWrite(uint8_t p, uint8_t d) {
  if (_i2cAddr != 255) {
    ...
    // straightup IO
    //digitalWrite(p, d); // hujang
    printf("unsupported digitalWrite\n");
  }
}
