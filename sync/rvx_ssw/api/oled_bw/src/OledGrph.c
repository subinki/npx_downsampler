...
extern unsigned char *	pbOledCur;
extern unsigned char		rgbOledBmp[];
extern unsigned char		rgbFillPat[];
extern int		bnOledCur;
extern unsigned char		clrOledCur;
extern unsigned char *	pbOledPatCur;
extern unsigned char	*	pbOledFontUser;
extern unsigned char *	pbOledFontCur;
...
unsigned char	(*pfnDoRop)(unsigned char bPix, unsigned char bDsp, unsigned char mskPix);
int		modOledCur;
...
void	OledMoveRight();
void	OledMoveLeft();
unsigned char	OledRopSet(unsigned char bPix, unsigned char bDsp, unsigned char mskPix);
unsigned char	OledRopOr(unsigned char bPix, unsigned char bDsp, unsigned char mskPix);
unsigned char	OledRopAnd(unsigned char bPix, unsigned char bDsp, unsigned char mskPix);
unsigned char	OledRopXor(unsigned char bPix, unsigned char bDsp, unsigned char mskPix);
...
void
OledSetDrawColor(unsigned char clr)
	{
...
void
OledSetFillPattern(unsigned char * pbPat)
	{
...
void
OledGetBmp(int dxco, int dyco, unsigned char * pbBits)
	{
	int		xcoLeft;
	int		xcoRight;
	int		ycoTop;
	int		ycoBottom;
	unsigned char *	pbDspCur;
	unsigned char *	pbDspLeft;
	unsigned char *	pbBmpCur;
	unsigned char *	pbBmpLeft;
	int		xcoCur;
	int		bnAlign;
	unsigned char	mskEnd;
...
void
OledPutBmp(int dxco, int dyco, unsigned char * pbBits)
	{
	int		xcoLeft;
	int		xcoRight;
	int		ycoTop;
	...
	unsigned char	bBmp;
	unsigned char	mskEnd;
	unsigned char	mskUpper;
	unsigned char	mskLower;
	int		bnAlign;
	int		fTop;
...
unsigned char
OledRopSet(unsigned char bPix, unsigned char bDsp, unsigned char mskPix)
	{
...
unsigned char
OledRopOr(unsigned char bPix, unsigned char bDsp, unsigned char mskPix)
	{
...
unsigned char
OledRopAnd(unsigned char bPix, unsigned char bDsp, unsigned char mskPix)
	{
...
unsigned char
OledRopXor(unsigned char bPix, unsigned char bDsp, unsigned char mskPix)
	{
