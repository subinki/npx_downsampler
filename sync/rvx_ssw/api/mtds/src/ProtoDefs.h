...
#define	cmdGdiSetIntensity			0x16		// set oled_rgb_draw_bitmap intensity
#define	cmdGdiGetIntensity			0x17		// return current oled_rgb_draw_bitmap intensity
...
#define	cmdGdioled_rgb_draw_bitmap			0x4A
