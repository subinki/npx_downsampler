...
`define NODE_ID_I_SNIM_I_DCA_MATRIX_DOWNSAMPLER00_CONTROL_MMIOX1_INTERFACE_MMIO (3)
`define NODE_ID_I_MNIM_I_MAIN_CORE_NO_NAME (2)
`define NODE_ID_I_MNIM_PLATFORM_CONTROLLER_MASTER (3)
`define NODE_ID_I_MNIM_I_DCA_MATRIX_DOWNSAMPLER00_MA_MLSU_NOC_PART (0)
`define NODE_ID_I_MNIM_I_DCA_MATRIX_DOWNSAMPLER00_MC_MLSU_NOC_PART (1)
